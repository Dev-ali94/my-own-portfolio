        ...
        <div className="container mx-auto px-4">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="relative rounded-3xl overflow-hidden mb-12">
            ...
            <div className="absolute bottom-8 md:bottom-24 left-4 right-4 md:left-8 md:right-8 flex flex-col items-center text-center">
              ...
              <p className="text-muted-foreground mt-2 max-w-xl px-4 text-sm md:text-base">{project.description}</p>
          ...
          {/* Project Info Cards */}
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            {[
          ...
          {/* Challenge & Solution */}
          <motion.section initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.5 }} className="grid md:grid-cols-2 gap-6 mb-12">
          ...
          <motion.section initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.8 }} className="mb-12">
            ...
            <div className="grid md:grid-cols-3 gap-4">
              {project.gallery?.map((img, index) => (
                ...
                >
                  <img src={img} alt={`${project.title} screenshot ${index + 1}`} className="w-full h-48 object-full hover:scale-105 transition-transform duration-300" />
                </motion.div>
              ))}
            </div>
          </motion.section>
